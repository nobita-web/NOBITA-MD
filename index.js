...
const ownerNumber = ['918850252808']
...
console.log('NOBITA-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ NOBITA-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb7VJVYGU3BST66hmd32*
...
//================ownerreact==============
if(senderNumber.includes("918850252808")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("918850252808")){
...
app.get("/", (req, res) => {
res.send("HEY, NOBITA-MD STARTED ✅");
});
